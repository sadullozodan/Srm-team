  ...
  return (
    <div ref={box} className="relative w-full max-w-md">
      ...
      <Input
        ...
        className="h-11 rounded-xl border-border/75 bg-card/80 pl-9 shadow-[0_10px_28px_rgb(31_37_60_/_0.06)]"
      />
      {isFetching && (
      ...
      {open && query.length >= 2 && (
        <div className="absolute top-13 left-0 z-50 max-h-[70vh] w-full overflow-y-auto rounded-2xl border border-border/75 bg-popover/95 p-2 shadow-[0_24px_70px_rgb(20_24_38_/_0.18)] backdrop-blur-xl dark:shadow-[0_24px_70px_rgb(0_0_0_/_0.38)]">
          {total === 0 ? (
